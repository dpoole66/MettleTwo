...
public class ScanDecision : Decision {
   ...
   private bool Scan(StateController controller){
        ...
        controller.transform.Rotate(0, controller.mettleStatus.searchingTurnSpeed * Time.deltaTime, 0);
        controller.m_Anim.SetTrigger("Looking");
        // check aginst enemyStats
        return controller.CheckIfCountDownElapsed(controller.mettleStatus.searchDuration);
