...
public class StateController_Player: MonoBehaviour {
    ...
    public void SetupAI(bool aiActivationFromMettleManager) {         
    ...
    private void OnDrawGizmos() {
        if(currentState != null && m_MettleEye != null){
            ...
            Gizmos.DrawWireSphere(m_MettleEye.position, playerStatus.lookSphereCastRadius);
